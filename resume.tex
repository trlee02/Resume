...
\begin{tightemize}
        ...
        \item Setup a directory structure and Gazebo enviroment in Linux needed to run a OpenCV data collection program for convolution neural network training for robot self driving.
        \item Managed features with teammate using Git version control and GitHub.
