...
% Change the geometry
\geometry{left=1.4cm, top=1.3cm, right=1.4cm, bottom=1.3cm, footskip=.5cm}
...
\setlength\headheight{36pt} %% just to make warning go away. Adjust the value after looking into the warning.
% 

\lhead{\includegraphics[width=\textwidth]{sciencecoop_header.png}}
